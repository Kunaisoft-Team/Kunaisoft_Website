        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold mb-3 text-[#253557]">{service.title}</h3>
